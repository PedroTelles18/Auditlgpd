...
if (-not (Test-Path ".env")) {
    ...
    Write-Host "`n  ⚠️  Arquivo .env criado a partir do .env.example" -ForegroundColor Yellow
    Write-Host "  ⚠️  EDITE o .env com sua DATABASE_URL e SECRET_KEY antes de continuar!" -ForegroundColor Yellow
